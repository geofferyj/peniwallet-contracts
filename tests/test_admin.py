def test_add_admin(peniwallet, accounts):
    # Add an admin
    peniwallet.addAdmin(accounts[1], sender = accounts[0])
...
def test_remove_admin(peniwallet, accounts):
    ...
    # Remove the admin
    peniwallet.removeAdmin(accounts[1], sender = accounts[0])
...
def test_admin_added_event(peniwallet, accounts):
    # Add an admin
    tx = peniwallet.addAdmin(accounts[1], sender = accounts[0])
...
def test_admin_removed_event(peniwallet, accounts):
    ...
    # Remove the admin
    tx = peniwallet.removeAdmin(accounts[1], sender = accounts[0])
